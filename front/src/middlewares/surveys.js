...
export default (store) => (next) => (action) => {
  switch (action.type) {
    case GET_SURVEYS: {
      ...
      axios.get(`http://localhost/Apotheose/Odyssea/back/odyssea/public/api/questions/${environmentSlug}/${categorySlug}`, {
        headers: {
    ...
    case SEND_RESULTS: {
      ...
      if (!action.isExempleQuiz) {
        ...
        axios.post(`http://localhost/Apotheose/Odyssea/back/odyssea/public/api/score`, {
          environment,
          category,
          user,
          points,
