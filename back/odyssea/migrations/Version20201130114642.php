 ...
 */
final class Version20201130114642 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answer_image (id INT AUTO_INCREMENT NOT NULL, question_image_id INT DEFAULT NULL, value VARCHAR(255) NOT NULL, image_link VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_5E07ED0C5EAD9561 (question_image_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE question_image (id INT AUTO_INCREMENT NOT NULL, correct_answer_id INT NOT NULL, category_id INT DEFAULT NULL, environment_id INT DEFAULT NULL, type VARCHAR(50) NOT NULL, name VARCHAR(255) NOT NULL, title LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_F5D6155BFD2E7CF7 (correct_answer_id), INDEX IDX_F5D6155B12469DE2 (category_id), INDEX IDX_F5D6155B903E3A94 (environment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
